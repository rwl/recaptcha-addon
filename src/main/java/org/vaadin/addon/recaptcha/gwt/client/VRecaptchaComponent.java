...
public class VRecaptchaComponent extends Widget implements Paintable {

    /** Set the CSS class name to allow styling. */
    public static final String CLASSNAME = "v-recaptchacomponent";
	...
	rw = new RecaptchaWidget("6LeeYtASAAAAAH-oArDa8zkFQLwUzE4UtLDxDkxZ");
